{
  ...
  // change filename in lines below
   ...
   Double_t Egam;
   Double_t pgam;
   TLorentzVector* kaonp4   = new TLorentzVector( 0, 0, 0 , 0);
   TLorentzVector* protonp4 = new TLorentzVector( 0, 0, 0 , 0);
   ...
   T->SetBranchAddress("P4K.Phi()", &Phi);
   ...
   for (Long64_t i=0; i<nentries;i++) 
     {
       ...
       // 	   //       cout << LogWt[j] << endl;
       // 	 maxLogWt = (logL + logWt);
       std::cout<<"angle: "<<P4K.Phi()<<std::endl;
     }
