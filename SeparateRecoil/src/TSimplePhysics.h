...
public:
 ...
 // virtual void     TestValues();
  ...
  virtual void     SetMeanStdDev(float mean, float stdev);
  ...
  // These are just to give an indication of how much time is spent "redo-ing" 
  // points because they fall outwith these bounds for R.
  int accepted;
  int rejected;
