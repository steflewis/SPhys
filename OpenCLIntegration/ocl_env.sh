...
export OPENCL_DIR= $HOME/NestedSampling/BeamRecoil/ # dir containing OpenCLIntegration folder!
...
#export PYTHONPATH=/home/Stefanie/NestedSampling/BeamRecoil/OpenCLIntegration/:$PYTHONPATH
